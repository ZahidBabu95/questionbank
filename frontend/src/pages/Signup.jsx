            ...
            <div className="hidden lg:flex w-1/2 bg-[#0F172A] relative overflow-hidden flex-col justify-between p-16 text-white">
                <div className="absolute inset-0 z-0 select-none">
                    <motion.div
                        ...
                        className="absolute top-0 left-[-10%] w-[600px] h-[600px] bg-indigo-600/20 rounded-full blur-[120px]"
                    ></motion.div>
                    <motion.div
                        initial={{ opacity: 0, scale: 0.8 }}
                        animate={{ opacity: 1, scale: 1 }}
                            ...
                            <div className="flex items-start ml-1">
                                ...
                                <div className="ml-3 text-xs">
                                    <label htmlFor="terms" className="font-medium text-slate-600">
                                        I agree to the <a href="#" className="font-bold text-blue-600 hover:text-blue-700">Terms of Service</a> and <a href="#" className="font-bold text-blue-600 hover:text-blue-700">Privacy Policy</a>
                                    </label>
                                </div>
                            </div>
