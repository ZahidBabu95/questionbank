            ...
            <div className="hidden lg:flex w-1/2 bg-[#0F172A] relative overflow-hidden flex-col justify-between p-16 text-white">
                <div className="absolute inset-0 z-0 select-none">
                    <motion.div
                        ...
                        className="absolute top-0 left-[-10%] w-[600px] h-[600px] bg-secondary/20 rounded-full blur-[120px]"
                    ></motion.div>
                    <motion.div
                        initial={{ opacity: 0, scale: 0.8 }}
                        animate={{ opacity: 1, scale: 1 }}
                        transition={{ duration: 1.5, ease: "easeOut", delay: 0.5 }}
                        className="absolute bottom-[-10%] right-[-10%] w-[500px] h-[500px] bg-primary/20 rounded-full blur-[100px]"
                    ></motion.div>
                </div>
                ...
                <div className="relative z-10 max-w-xl">
                    ...
                    >
                        ...
                        <p className="text-slate-400 text-xl leading-relaxed mb-12">
                            Create an account to access the most advanced question bank and exam management tools in Bangladesh.
                        </p>
                    </motion.div>
                    ...
                    >
                        <div className="flex items-center gap-4 px-6 py-4 bg-white/5 rounded-2xl border border-white/5 backdrop-blur-md hover:bg-white/10 transition-colors duration-300">
                            ...
                            <div>
                                <h4 className="font-semibold text-white">Free 14-day trial</h4>
            ...
            <div className="w-full lg:w-1/2 flex items-center justify-center p-8 lg:p-16 bg-white overflow-y-auto">
                ...
                >
                    <div className="text-center lg:text-left">
                        ...
                        <p className="mt-2 text-slate-500">Join us to streamline your academic workflow.</p>
                    </div>
                    ...
                    <div className="space-y-6">
                        ...
                        <div className="relative flex items-center justify-center">
                            ...
                            <span className="bg-white px-4 text-xs font-bold text-slate-400 uppercase tracking-widest relative z-10">or sign up with email</span>
                        </div>
                            ...
                            <div className="flex items-start ml-1">
                                ...
                                <div className="ml-3 text-xs">
                                    <label htmlFor="terms" className="font-medium text-slate-600">
                                        I agree to the <Link to="/terms" target="_blank" className="font-bold text-primary hover:text-blue-700">Terms of Service</Link> and <Link to="/privacy" target="_blank" className="font-bold text-primary hover:text-blue-700">Privacy Policy</Link>
                                    </label>
                                </div>
                            </div>
                    ...
                    <div className="text-center pt-2">
                        <p className="text-slate-500 font-medium">
                            ...
                            <Link to="/login" className="font-bold text-primary hover:text-blue-700 transition-colors hover:underline">
                                Sign in
                            </Link>
                        </p>
                    </div>
