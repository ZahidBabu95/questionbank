        ...
        <div className="space-y-6">
            ...
            <div className="bg-white p-6 rounded-xl shadow-sm border border-slate-200 flex justify-between items-start">
                <div className="flex gap-4">
                    <div className="w-16 h-16 bg-blue-100 rounded-xl flex items-center justify-center text-primary">
                        <Building2 size={32} />
                    </div>
                    <div>
                ...
                <button onClick={() => navigate(`/institutes/edit/${institute.id}`)} className="text-primary hover:text-blue-700 flex items-center gap-2">
                    <Edit size={18} /> Edit
                </button>
            </div>
