    ...
    return (
        <div className={`p-6 overflow-y-auto flex-1 custom-scrollbar ${isDark ? 'text-slate-300' : ''}`}>
            ...
            <div className="space-y-6">
                ...
                {selectedQuestion.correctAnswer && selectedQuestion.type !== 'MCQ' && !selectedQuestion.dynamicData && (selectedQuestion.type !== 'CQ' || !selectedQuestion.correctAnswer.includes('cq-ans-part')) && (
                    <div>
                ...
                {selectedQuestion.explanation && !selectedQuestion.dynamicData && (selectedQuestion.type !== 'CQ' || !selectedQuestion.explanation.includes('cq-exp-part')) && (
                    <div>
